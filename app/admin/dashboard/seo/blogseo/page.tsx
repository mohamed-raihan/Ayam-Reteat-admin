...
export default function HomeSeo() {
  ...
  const fetchSeo = async () => {
    const res = await api.get(API_URL.SEO.BLOG_SEO);
    console.log(res);
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6 bg-gradient-to-r from-purple-600 to-indigo-600 px-4 rounded-lg py-4">
        <div>
          <h2 className="text-2xl font-bold text-white">Blog SEO</h2>
          <p className="text-sm text-gray-500 text-white">Manage SEO details for your blog page</p>
        </div>
